    ...
    <section className="prices relative">
      <div className="container z-10 relative">
        <div className="wrapper">
          ...
          {/* Desktop version */}
          <div className="desktop-content relative z-10 hidden md:grid xl:grid-cols-9 gap-5 w-full border-2 border-primary/20 rounded-xl py-8 px-6 mt-10">
            {/* Left side */}
          ...
          {/* Mobile version */}
          <div className="mobile-content relative flex flex-wrap gap-4 md:gap-12 justify-center items-center mt-10">
            <div className="top font-medium">
              <div className="heading grid gap-5">
                ...
                <div className="prices flex flex-wrap gap-4">
                  <div className="price">
                    <button
                      className={`w-[7rem] py-3 px-6 rounded-md  transition-all duration-300 leading-[0.7] whitespace-nowrap ${
